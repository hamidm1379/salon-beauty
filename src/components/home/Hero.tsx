        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center ">
          ...
          <motion.div initial="hidden" animate="visible" className="text-center lg:text-right">
            ...
            <motion.h1
              variants={fadeUp}
              custom={1}
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.2] tracking-tight"
            >
            ...
            <motion.p
              variants={fadeUp}
              custom={3}
              className="text-[var(--color-ink-muted)] text-lg max-w-lg lg:ml-0 mx-auto leading-relaxed"
            >
            ...
            >
              <Link
                href="/blog"
                className="group relative inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-l from-[var(--color-primary)] to-[var(--color-primary-soft)] text-white px-8 py-4 font-medium text-sm overflow-hidden transition-all duration-300 hover:shadow-[0_8px_30px_-4px_rgba(124,58,237,0.4)]"
              >
              ...
              <Link
                href="/services"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-[var(--color-ink)]/15 px-8 py-4 font-medium text-sm text-[var(--color-ink)] hover:bg-[var(--color-bg-soft)] hover:border-[var(--color-gold-accent)]/30 transition-all duration-300"
              >
                مشاهده خدمات
