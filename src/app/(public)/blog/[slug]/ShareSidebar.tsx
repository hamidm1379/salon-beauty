...
export function ShareSidebar({ shareUrl, title }: ShareSidebarProps) {
      ...
      <div className="space-y-2.5">
        {shareLinks.map((link) => (
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className={`flex items-center gap-3 w-full px-4 py-3 rounded-xl ${link.bg} ${link.hover} transition-colors`}
          >
        ...
        <motion.button
          ...
          className={`flex items-center gap-3 w-full px-4 py-3 rounded-xl transition-colors ${
            copied
              ...
              : "bg-[var(--color-ink)]/5 text-[var(--color-ink-muted)] hover:bg-[var(--color-ink)]/10"
          }`}
        >
